...
var file_push_proto_rawDesc = []byte{
	0x0a, 0x0a, 0x70, 0x75, 0x73, 0x68, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x15, 0x67, 0x69,
	0x64, 0x79, 0x6f, 0x6e, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x2e, 0x70,
	0x75, 0x73, 0x68, 0x1a, 0x1b, 0x67, 0x6f, 0x6f, 0x67, 0x6c, 0x65, 0x2f, 0x70, 0x72, 0x6f, 0x74,
	...
	0x61, 0x74, 0x69, 0x6f, 0x6e, 0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0xe9, 0x01, 0x0a,
	0x0b, 0x50, 0x75, 0x73, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x23, 0x0a, 0x0d,
	...
	0x65, 0x12, 0x49, 0x0a, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x18, 0x04, 0x20, 0x03,
	0x28, 0x0b, 0x32, 0x2f, 0x2e, 0x67, 0x69, 0x64, 0x79, 0x6f, 0x6e, 0x2e, 0x6d, 0x65, 0x73, 0x73,
	0x61, 0x67, 0x69, 0x6e, 0x67, 0x2e, 0x70, 0x75, 0x73, 0x68, 0x2e, 0x50, 0x75, 0x73, 0x68, 0x4d,
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x2e, 0x44, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x45, 0x6e,
	...
	0x61, 0x6c, 0x75, 0x65, 0x3a, 0x02, 0x38, 0x01, 0x32, 0x5e, 0x0a, 0x0d, 0x50, 0x75, 0x73, 0x68,
	0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x12, 0x4d, 0x0a, 0x0f, 0x53, 0x65, 0x6e,
	0x64, 0x50, 0x75, 0x73, 0x68, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x22, 0x2e, 0x67,
	0x69, 0x64, 0x79, 0x6f, 0x6e, 0x2e, 0x6d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x2e,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x69, 0x6e, 0x67, 0x2f, 0x70, 0x75, 0x73, 0x68, 0x62, 0x06, 0x70,
...
var file_push_proto_goTypes = []interface{}{
	(*PushMessage)(nil), // 0: gidyon.messaging.push.PushMessage
	nil,                 // 1: gidyon.messaging.push.PushMessage.DetailsEntry
	(*empty.Empty)(nil), // 2: google.protobuf.Empty
}
var file_push_proto_depIdxs = []int32{
	1, // 0: gidyon.messaging.push.PushMessage.details:type_name -> gidyon.messaging.push.PushMessage.DetailsEntry
	0, // 1: gidyon.messaging.push.PushMessaging.SendPushMessage:input_type -> gidyon.messaging.push.PushMessage
	2, // 2: gidyon.messaging.push.PushMessaging.SendPushMessage:output_type -> google.protobuf.Empty
...
func (c *pushMessagingClient) SendPushMessage(ctx context.Context, in *PushMessage, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/gidyon.messaging.push.PushMessaging/SendPushMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PushMessaging_SendPushMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gidyon.messaging.push.PushMessaging/SendPushMessage",
	}
...
var _PushMessaging_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gidyon.messaging.push.PushMessaging",
