...
type NewEmailAPIClientMockT interface {
	mock.TestingT
	Cleanup(func())
}

// NewEmailAPIClientMock creates a new instance of EmailAPIClientMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewEmailAPIClientMock(t NewEmailAPIClientMockT) *EmailAPIClientMock {
	mock := &EmailAPIClientMock{}
	mock.Mock.Test(t)
