...
type NewChannelAPIClientMockT interface {
	mock.TestingT
	Cleanup(func())
}

// NewChannelAPIClientMock creates a new instance of ChannelAPIClientMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewChannelAPIClientMock(t NewChannelAPIClientMockT) *ChannelAPIClientMock {
	mock := &ChannelAPIClientMock{}
	mock.Mock.Test(t)
