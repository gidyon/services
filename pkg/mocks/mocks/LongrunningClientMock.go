...
type NewLongrunningClientMockT interface {
	mock.TestingT
	Cleanup(func())
}

// NewLongrunningClientMock creates a new instance of LongrunningClientMock. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewLongrunningClientMock(t NewLongrunningClientMockT) *LongrunningClientMock {
	mock := &LongrunningClientMock{}
	mock.Mock.Test(t)
